...
void NeroFatJets::init()
{
  ...
  mcParams.push_back(JetCorrectorParameters(jecDir + "Spring16_25nsV3_MC_L2Relative_AK8PFchs.txt"));
  mcParams.push_back(JetCorrectorParameters(jecDir + "Spring16_25nsV3_MC_L3Absolute_AK8PFchs.txt"));
  mMCJetCorrector = new FactorizedJetCorrector(mcParams);
  
  std::vector<JetCorrectorParameters> dataParams;
  dataParams.push_back(JetCorrectorParameters(jecDir + "Spring16_25nsV3_DATA_L2Relative_AK8PFchs.txt"));
  dataParams.push_back(JetCorrectorParameters(jecDir + "Spring16_25nsV3_DATA_L3Absolute_AK8PFchs.txt"));
  dataParams.push_back(JetCorrectorParameters(jecDir + "Spring16_25nsV3_DATA_L2L3Residual_AK8PFchs.txt"));
